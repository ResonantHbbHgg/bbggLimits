...
combine -M Asymptotic -d hhbbgg_13TeV_DataCard.root -t -1 --expectSignal 1 -m 125 -n SM_13TeV_3ab -S 0 &>Limit_stat.txt

combine -M Asymptotic -d hhbbgg_13TeV_DataCard.root -t -1 --expectSignal 1 -m 125 -n SM_13TeV_3ab &>Limit.txt
