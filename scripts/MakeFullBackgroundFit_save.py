...
#  var.Print()
  ...
  print signormName+str(cc)+'_proc_Sig'
...
#  bkg_pdf.plotOn(frame,RooFit.LineColor(cNiceGreenDark), RooFit.LineStyle(kDashed), RooFit.Precision(1E-5), RooFit.Normalization(bkg_norm.getVal(), RooAbsReal.NumEvent))
#  totBkg.plotOn(frame,RooFit.LineColor(cNiceRed),RooFit.Precision(1E-5), RooFit.Normalization(totBkgNorm, RooAbsReal.NumEvent))
#  sig_pdf.plotOn(frame,RooFit.LineColor(cNiceBlueDark), RooFit.Precision(1E-5), RooFit.Normalization(opt.snorm[intc]*opt.fsignal[intc],RooAbsReal.NumEvent))
